    ...
    <div className="flex p-4 border-b dark:border-gray-600 text-sm">
        ...
        <div className="flex-1">
            ...
            border-t dark:border-gray-700 max-w-fit gap-2">
                ...
                className={`text-gray-700 dark:text-gray-300 hover:text-fuchsia-500 dark:hover:text-fuchsia-500 ${
                    currentUser && comment.likes.includes(currentUser._id) && '!text-[#3688B7]'}`}>
                ...
                </p>
                {
                    currentUser && (currentUser._id === comment.userId || currentUser.isAdmin) && (
                        <button
                          type='button'
                          onClick={handleEdit}
                          className="text-gray-400 dark:text-gray-500 hover:text-fuchsia-500 dark:hover:text-fuchsia-500">
                            Edit
                        </button>
                    ) 
                }
